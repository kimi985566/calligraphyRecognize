...
JNIEXPORT void JNICALL
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_enableLog(
        JNIEnv *env, jobject thiz, jboolean enabled) {}

JNIEXPORT jint JNICALL
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_loadModel(
...
JNIEXPORT void JNICALL
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_setScale(
