...
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_setNumThreads(JNIEnv *env,
                                                             jobject thiz,
                                                             jint numThreads) {
...
JNIEXPORT void JNICALL Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_enableLog(
    JNIEnv *env, jobject thiz, jboolean enabled) {}

JNIEXPORT jint JNICALL Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_loadModel(
...
JNIEXPORT void JNICALL
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_setMeanWithMeanFile(
...
JNIEXPORT void JNICALL
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_setMeanWithMeanValues(
...
JNIEXPORT void JNICALL Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_setScale(
...
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_getConfidenceScore(
...
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_predictImage(
    JNIEnv *env, jobject thiz, jbyteArray buf, jint width, jint height,
    jint k) {
  CaffeMobile *caffe_mobile = CaffeMobile::Get();
  vector<int> top_k =
...
Java_yangchengyu_shmtu_edu_cn_calligraphyrecognize_utils_CaffeMobile_extractFeatures(
    JNIEnv *env, jobject thiz, jbyteArray buf, jint width, jint height,
    jstring blobNames) {
  CaffeMobile *caffe_mobile = CaffeMobile::Get();
